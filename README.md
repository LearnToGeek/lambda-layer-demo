...
This is a sample template for lambda_layer_demo - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name lambda_layer_demo --query 'Stacks[].Outputs'
```
